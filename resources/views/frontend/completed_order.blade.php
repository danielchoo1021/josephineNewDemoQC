			...
			<div class="row justify-content-center">
				...
				<div class="col pb-3" align="center">
					<a href="{{ route('completed_order') }}" style="position: relative; display: inline-block;">
						...
						<br>
						<span class="profile-word" style="font-weight: bold; text-decoration: underline;">{{ isset($data['lang']['lang']['completed']) ? $data['lang']['lang']['completed'] :'已完成'}}</span>
					</a>
				</div>
						...
						@foreach($allCouriers[$transaction->id] as $allCourier)
							...
							<div class="form-group">
								<a href="{{ route('logistic_tracking', $allCourier->order_number) }}" style="color: #ffa023">
									<i class="fa fa-truck" aria-hidden="true" style="font-size: 17px;"></i> &nbsp;&nbsp;&nbsp; [{{ $allCourier->courier }}] {{ $ship_details[$transaction->id][$allCourier->id] }}
								</a>
							</div>
							@endif
						@endforeach

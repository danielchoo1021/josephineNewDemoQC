			...
			<div class="row justify-content-center">
				...
				<div class="col pb-3" align="center">
					<a href="{{ route('cancelled_order') }}" style="position: relative; display: inline-block;">
						...
						<br>
						<span class="profile-word" style="font-weight: bold; text-decoration: underline;">{{ isset($data['lang']['lang']['cancelled']) ? $data['lang']['lang']['cancelled'] :'已取消'}}</span>
					</a>
				</div>
			</div>
		</div>
				...
				<div class="form-group container-box">
					<div class="row">
						...
						<div class="col-6" align="right">
							...
							@endif
							<!-- <input type="text" name="tid" id="tid" value="{{ $transaction->transaction_no }}"> -->
						</div>
					</div>
					<hr>

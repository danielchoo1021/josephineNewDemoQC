...
<div class="profile-content pb-5">
			...
			<div class="row justify-content-center">
				...
				<div class="col pb-3" align="center">
					<a href="{{ route('pending_shipping') }}" style="position: relative; display: inline-block;">
						...
						<br>
						<span class="profile-word" style="font-weight: bold; text-decoration: underline;">{{ isset($data['lang']['lang']['to_be_delivered']) ? $data['lang']['lang']['to_be_delivered'] :'待出货'}}</span>
					</a>
				</div>
 ...
 -->
					...
					<div class="row">
						...
						<div class="col-6" align="right">
							@if($transaction->pv_purchase == 1)
								{{ isset($data['lang']['lang']['sub_total']) ? $data['lang']['lang']['sub_total'] :'合计'}}: {{ number_format($transaction->grand_total, 2) }} {{ isset($data['lang']['lang']['point']) ? $data['lang']['lang']['point'] :'Point'}}
							@else

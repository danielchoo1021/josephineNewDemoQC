...
@endif
<form method="POST" action="{{ route('add_on_deal_save') }}" id="promotions-form" enctype="multipart/form-data">
@csrf
 ...
 //    });
    ...
    $('#update_all').on('click',function(){
        ...
        $.ajax({
            ...
            data:{discount:discount,limit:limit},
            success:function(data){
                if (data.status == 1) {
                     $('.loading-gif').hide();
    ...
    $(document).on('click','.check_all_sub_items',function(){
    ...
    $(document).on('click','.save_btn',function(){
        ...
        if(product_arr <= 0){
            ...
            if (confirm("{{ isset($data['backendlang']['backendlang']['Are_You_Sure_You_Want_To_Add_Those_Items']) ? $data['backendlang']['backendlang']['Are_You_Sure_You_Want_To_Add_Those_Items'] :'' }}") == true) {
                ...
                var title = $('input[name="promotion_name"]').val();
                ...
                $.ajax({
                    ...
                    data: {product:product,variation:variation,sec_variation:sec_variation,item_variation:item_variation,
                            title : title,
							start : start,
							end : end,},
                    success:function(data)
        ...
        if(product_arr <= 0){
            ...
            if (confirm("{{ isset($data['backendlang']['backendlang']['Are_You_Sure_You_Want_To_Add_Those_Items']) ? $data['backendlang']['backendlang']['Are_You_Sure_You_Want_To_Add_Those_Items'] :'' }}") == true) {
                ...
                $.ajax({
                    ...
                    data: {product:product,variation:variation,second_variation:second_variation,item_variation:item_variation,
                            title : title,
							start : start,
							end : end,
                    },

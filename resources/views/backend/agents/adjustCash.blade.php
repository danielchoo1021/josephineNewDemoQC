	    ...
	    <h3>
	        ...
	        <span>
	            <i class="ace-icon fa fa-angle-double-right"></i>
	           	{{ isset($data['backendlang']['backendlang']['Adjust_Cash_Wallet']) ? $data['backendlang']['backendlang']['Adjust_Cash_Wallet'] :'' }} 
	        </span>
	    </h3>
	</div>
	<div class="form-group">
		<span class="badge badge-pill bg-primary">{{ isset($data['backendlang']['backendlang']['Cash_Wallet_Balance']) ? $data['backendlang']['backendlang']['Cash_Wallet_Balance'] :'' }}: {{ $GetCashWalletBalance }}</span>
	</div>
	<form method="POST" action="{{ route('adjustCash', $agent->id) }}">
		@csrf
		@if($errors->any())
...
<div class="container-box">
	...
	<div class="row">
		<div class="col-sm-12">
			<form method="GET" action="{{ route('adjustCash', $agent->id) }}">
				<div class="form-group">
					<div class="row">
						<div class="col-sm-2">
							<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<a href="{{ route('adjustCash', $agent->id) }}" class="btn btn-warning btn-sm">

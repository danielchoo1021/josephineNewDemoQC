...
<div class="container-box form-group">
	...
	<form method="POST" action="{{ route('AdjustTopup', $agent->id) }}">
		@csrf
		@if($errors->any())
...
<div class="container-box">
	...
	<div class="row">
		<div class="col-sm-12">
			<form method="GET" action="{{ route('AdjustTopup', $agent->id) }}">
				<div class="form-group">
					<div class="row">
						<div class="col-sm-2">
							<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<a href="{{ route('AdjustTopup', $agent->id) }}" class="btn btn-warning btn-sm">

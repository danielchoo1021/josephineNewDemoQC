...
border-radius: 10px;">
			...
			<div class="col-md-4">
				<div class="form-group">
					<a href="{{ route('tree_details', [$agent->code, '4']) }}">
						<div class="bs-callout bs-callout-warning" id="callout-alerts-dismiss-plugin" style="background-color: #fff;
padding: 20px;
border-radius: 10px;">
				    		<div class="form-group">
						    ...
						    <div class="row">
						    	<div class="col-md-12" align="right">
							    	<div class="progress progress-mini">
										<div class="progress-bar progress-danger" style="width: {{ $tfgp }}%;"></div>
									</div>
						    	</div>
		  ...
		  <ul class="tree">
		    	<li>
		    		<span>
		    			...
		    			<br>
		    			<a href="{{ route('agent.agents.edit', $agent->id) }}" target="_blank">
		      		...
		      		<ul>
		        		...
		        		<li>
		        			<span>
		        				...
		        				<img src="{{ !empty($agentDv->profile_logo) ? asset($agentDv->profile_logo) : asset('images/images.png') }}" width="100px" height="100px" style="border-radius: 100%;">
		        				<br>
		        				<a href="{{ route('agent.agents.edit', $agentDv->id) }}" target="_blank">
		        					{{ $agentDv->f_name }} {{ $agentDv->l_name }} ({{ $agentDv->code }})
		        				</a>
		        			</span>
		        			@if(!$mdd[$agentDv->code]->isEmpty())
			        			<ul>
			        				...
			        				<li>
			        					<span>
		        							...
		        							<br>
		        							<a href="{{ route('agent.agents.edit', $mddv->id) }}" target="_blank">
			        						...
			        						@foreach($mddd[$mddv->code] as $mdddv)
				        						<li>
				        							<span>
		        										...
		        										<br>
		        										<a href="{{ route('agent.agents.edit', $mdddv->id) }}" target="_blank">
				        							...
				        							<ul>
				        								...
				        								<li>
				        									<span>
		        												...
		        												<br>
		        												<a href="{{ route('agent.agents.edit', $mddddv->id) }}" target="_blank">

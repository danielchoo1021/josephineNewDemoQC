...
<div class="container-box form-group">
	...
	<div class="form-group">
		<span class="badge badge-pill bg-primary">{{ isset($data['backendlang']['backendlang']['Coin_Balance']) ? $data['backendlang']['backendlang']['Coin_Balance'] :'' }}: {{ $GetCashWalletBalance }}</span>
	</div>
	<form method="POST" action="{{ route('adjustCash', $merchant->id) }}">
		@csrf
		@if($errors->any())
		...
		<div class="submit-form-btn">
			<div class="form-group wizard-actions" align="right">
				<a href="{{ route('merchant_wallet') }}" class="btn btn-default">
...
<div class="container-box">
	...
	<div class="row">
		<div class="col-sm-12">
			<form method="GET" action="{{ route('adjustCash', $merchant->id) }}">
				<div class="form-group">
					<div class="row">
						<div class="col-sm-2">
							<div class="form-group">
								<select class="form-control" name="type">
									...
									<option {{ (!empty(request('type')) && request('type') == '1') ? 'selected' : '' }} value="1">
										{{ isset($data['backendlang']['backendlang']['Increase']) ? $data['backendlang']['backendlang']['Increase'] :'' }}e
									</option>
						...
						<div class="col-sm-4">
							...
							<a href="{{ route('adjustCash', $merchant->id) }}" class="btn btn-warning btn-sm">

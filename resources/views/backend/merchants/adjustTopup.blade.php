...
<div class="form-group">
	<span class="badge badge-pill badge-primary">{{ isset($data['backendlang']['backendlang']['Topup_Wallet_Balance']) ? $data['backendlang']['backendlang']['Topup_Wallet_Balance'] :'' }}: {{ $GetCashWalletBalance }}</span>
</div>
<form method="POST" action="{{ route('AdjustTopup', $merchant->id) }}">
	@csrf
	@if($errors->any())
...
<div class="row">
	<div class="col-sm-12">
		<form method="GET" action="{{ route('AdjustTopup', $merchant->id) }}">
			<div class="form-group">
				<div class="row">
					<div class="col-sm-2">
						<div class="form-group">
							<select class="form-control" name="type">
								...
								<option {{ (!empty(request('type')) && request('type') == '1') ? 'selected' : '' }} value="1">
									{{ isset($data['backendlang']['backendlang']['Increase']) ? $data['backendlang']['backendlang']['Incerase'] :'' }}
								</option>
					...
					<div class="col-sm-4">
						...
						<a href="{{ route('AdjustTopup', $merchant->id) }}" class="btn btn-warning btn-sm">

        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response['variation_enable'] == '1'){
                    ...
                    ele.closest('.row-parent-box').find('.pricing-list').html('<div class="col">\
                        ...
                        @endforeach');
                    // ele.closest('.container-box').find('.customer_price_box').html('Customer Price');
                    // ele.closest('.container-box').find('.customer_special_price_box').html('Customer Special Price <br>(2 quatity or more)');
                    // ele.closest('.container-box').find('.agentlvl_1').html('Freshman');
                    // ele.closest('.container-box').find('.agentlvl_2').html('Distributor');
                    // ele.closest('.container-box').find('.agentlvl_3').html('Director');
                }
            }
        });
    });

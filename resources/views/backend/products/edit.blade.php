...
$('#add-row-btn').click( function(e){
    ...
    $(this).closest('.variation_box').find('.parent_variation').append('<div class="form-group child-row">\
                                                                          <div class="row" style="display: flex; justify-content: center;">\
                                                                            ...
                                                                            <div class="col-md">\
                                                                              <input type="text" name="variation_get_point[]" class="form-control" placeholder="{{ isset($data['backendlang']['backendlang']['Point']) ? $data['backendlang']['backendlang']['Point'] :'' }}" value="">\
                                                                            </div>\
                                                                            <div class="col-md">\

  ...
  $('#upload_image').on('change', function(){
    ...
    reader.onload = function (event) {
      $image_crop.croppie('bind', {
        ...
        console.log("{{ isset($data['backendlang']['backendlang']['jQuery_bind_complete']) ? $data['backendlang']['backendlang']['jQuery_bind_complete'] :'' }}");
      });
    }
...
$('.add-v1-option').click( function(e){
    ...
    $('.variation-list-child-row').append('<tr data-id="'+total+'">\
                                              <td class="variation_option_display_'+total+' first_variation" rowspan="'+rowspan+'">{{ isset($data["backendlang"]["backendlang"]["Option"]) ? $data["backendlang"]["backendlang"]["Option"] :'' }}</td>\
...
$('.variation-parent-row').on("click", ".del-v1-btn", function(e){
    ...
    if(data_id){
        ...
        $('.variation-list-child-row').find('.added').filter(function(){return $(this).data('id') == row_id}).remove();
    }
});
...
$('.variation-parent-row').on("click", ".del-v2-btn", function(e){
    ...
    if(data_id){
        ...
        $('.variation-list-child-row').find('.first_variation').attr('rowspan', function(i, rs) { return rs - 1; });
    }
});

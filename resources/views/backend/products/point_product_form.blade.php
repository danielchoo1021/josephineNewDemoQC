	...
	<div class="col-12">
		<form method="POST" action="{{ $action_url }}" id="product-form">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-4 item_code">
						...
						{{ isset($product) ? ((isset($data['backendlang']['backendlang']['Item_Code']) ? $data['backendlang']['backendlang']['Item_Code'] : '') . ': ' . $product->item_code) : '' }}   
						@endif
					</div>
				</div>
			</div>
			...
			<div class="non-variation-tab"
				...
				<!-- <div class="form-group">
					<div class="row">
						...
						<div class="col-sm-10">
							<input type="text" name="get_point" class="form-control" value="{{ isset($product) ? $product->get_point : old('get_point') }}" placeholder="Get Point" onkeypress="return isNumberKey(event)">
						</div>
					</div>
				</div>-->
				<!--<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-10">
							<input type="text" name="get_pv" class="form-control" value="{{ isset($product) ? $product->get_pv : old('get_pv') }}" placeholder="Get PV" onkeypress="return isNumberKey(event)">
						</div>
					</div>
				</div> -->
				<div class="form-group">
					<div class="row">
						<div class="col-sm-6">
							<div class="row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="price" value="{{ isset($product) ? $product->price : old('price') }}" placeholder="{{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }} *" onkeypress="return isNumberKey(event)">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-sm-6">
							<div class="row">
								<div class="col-sm-4">
									{{ isset($data['backendlang']['backendlang']['Member_Birthday']) ? $data['backendlang']['backendlang']['Member_Birthday'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}: <span class="important-text">*</span>
								</div>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="birthday_price" value="{{ isset($product) ? $product->birthday_price : old('birthday_price') }}" placeholder="{{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }} *" onkeypress="return isNumberKey(event)">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="row">
								<div class="col-sm-4">
									{{ isset($data['backendlang']['backendlang']['Member_Birthday_Special']) ? $data['backendlang']['backendlang']['Member_Birthday_Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}: <span class="important-text">*</span>
								</div>
								<div class="col-sm-8">
				...
				<div class="row">
					...
					@php
						$out_price = (isset($agent_prices[$agentlvl->id])) ? $agent_prices[$agentlvl->id] : '';
						$out_special_price = (isset($agent_special_prices[$agentlvl->id])) ? $agent_special_prices[$agentlvl->id] : '';
						$out_get_pv = (isset($agent_get_pv[$agentlvl->id])) ? $agent_get_pv[$agentlvl->id] : '';
						$out_id = (isset($agent_prices_ids[$agentlvl->id])) ? $agent_prices_ids[$agentlvl->id] : '';
					
						$birthday_price = (isset($agent_birthday_price[$agentlvl->id])) ? $agent_birthday_price[$agentlvl->id] : '';
						$birthday_special_price = (isset($agent_birthday_special_price[$agentlvl->id])) ? $agent_birthday_special_price[$agentlvl->id] : '';
					@endphp
						<div class="col-sm-6">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										<b>{{ $agentlvl->agent_lvl }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}:</b> <span class="important-text">*</span>
									</div>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="every_agent_price[]" value="{{ $out_price }}" placeholder="{{ $agentlvl->agent_lvl }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }} *" onkeypress="return isNumberKey(event)">
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										{{ $agentlvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Special']) ? $data['backendlang']['backendlang']['Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}: <span class="important-text">*</span>
									</div>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="every_agent_special_price[]" value="{{ $out_special_price }}" placeholder="{{ $agentlvl->agent_lvl }} Special {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }} *" onkeypress="return isNumberKey(event)">
									</div>
								</div>   
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										{{ $agentlvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Birthday']) ? $data['backendlang']['backendlang']['Birthday'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}: <span class="important-text">*</span>
									</div>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="level_price[]" value="{{ $birthday_price }}" placeholder="{{ $agentlvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Birthday']) ? $data['backendlang']['backendlang']['Birthday'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }} *" onkeypress="return isNumberKey(event)">
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										{{ $agentlvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Birthday_Special']) ? $data['backendlang']['backendlang']['Birthday_Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}: <span class="important-text">*</span>
									</div>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="level_special_price[]" value="{{ $birthday_special_price }}" placeholder="{{ $agentlvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Birthday_Special']) ? $data['backendlang']['backendlang']['Birthday_Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }} *" onkeypress="return isNumberKey(event)">
									</div>
								</div>
							</div>
						</div>
			...
			<div class="variation-tab" 
				...
				<div class="row">
					<div class="col-11">
						<h4>{{ isset($data['backendlang']['backendlang']['Product_Variation']) ? $data['backendlang']['backendlang']['Product_Variation'] :'' }}</h4>
					</div>
					...
					<div class="col-6">
						...
						<div class="form-group">
							<a href="#" class="btn btn-outline-primary btn-block add-v1-option">
								<i class="fa fa-plus"></i> {{ isset($data['backendlang']['backendlang']['Add_Option']) ? $data['backendlang']['backendlang']['Add_Option'] :'' }}
							</a>
						</div>
					</div>
				</div>
					...
					<div class="col-6">
						<div class="hide_variation_two_area">
							<a href="#" class="btn btn-outline-primary btn-block">
								<i class="fa fa-plus"></i> {{ isset($data['backendlang']['backendlang']['Add']) ? $data['backendlang']['backendlang']['Add'] :'' }}
							</a>
						</div>
				...
				<div class="row ">
					...
					<div class="col-10" style="overflow: auto;">
						<table class="table table-bordered variation-list-child-row table-responsive">
							<tr>
								<td class="variation_title">{{ isset($product) ? $product->second_variation_title : (isset($data['backendlang']['backendlang']['Name']) ? $data['backendlang']['backendlang']['Name'] : 'Name') }}</td>
								<td class="variation_two variation_two_title" style="display: none;">
									{{ isset($product) ? $product->second_variation_title : (isset($data['backendlang']['backendlang']['Name']) ? $data['backendlang']['backendlang']['Name'] : 'Name') }}
								</td>
								 
								<!--<td>Get PV</td> -->
								<td>{{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}</td>
								<td>{{ isset($data['backendlang']['backendlang']['Special']) ? $data['backendlang']['backendlang']['Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}</td>
								...
								<td>{{ $a_lvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Special']) ? $data['backendlang']['backendlang']['Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}</td>
								<td>{{ $a_lvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Birthday']) ? $data['backendlang']['backendlang']['Birthday'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}</td>
								<td>{{ $a_lvl->agent_lvl }} {{ isset($data['backendlang']['backendlang']['Birthday_Special']) ? $data['backendlang']['backendlang']['Birthday_Special'] :'' }} {{ (!empty($mall) && $mall == '1') ? ($data['backendlang']['backendlang']['Point'] ?? '') : ($data['backendlang']['backendlang']['Price'] ?? '') }}</td>
								@endforeach
								<td>{{ isset($data['backendlang']['backendlang']['Costing']) ? $data['backendlang']['backendlang']['Costing'] :'' }}</td>
								<td>{{ isset($data['backendlang']['backendlang']['Weight']) ? $data['backendlang']['backendlang']['Weight'] :'' }}</td>
								<!--<td>Get Point</td>-->
							...
							@if(isset($variations) && !$variations->isEmpty())
								...
								@if($product->second_variation_enable == 1)
									...
									@foreach($s_secnd_variations[$varia->id] as $s_secnd_variation)
										<tr class="added-v2-option_{{ $slrow }} added" data-id="{{ $lrow }}">
											...
											<td><input type="text" class="form-control" name="birthday_special_price_{{ $vkey }}[]" value="{{$s_secnd_variation->variation_birthday_price}}"></td>
											@foreach($agent_levels as $key => $agentlvl)
											@php
											...
											<input type="hidden" name="get_point_{{ $vkey }}[]" class="form-control" value="{{ $s_secnd_variation->variation_get_point }}">
										</tr>
									@php
									$slrow++;
									@endphp
								...
								@else
									...
									<tr data-id="{{ $lrow }}">
										...
										<td><input type="text" class="form-control" name="birthday_special_price_{{ $lrow }}[]" value="{{$varia->variation_birthday_price}}"></td>
										@foreach($agent_levels as $key => $agentlvl)
										...
										<input type="hidden" name="get_point_{{ $lrow }}[]" class="form-control" value="{{ $varia->variation_get_point }}">
									</tr>
									@php
									$lrow++;
									@endphp
							...
							@else
								<tr data-id="0">
									...
									<!--<td><input type="text" name="get_pv_0[]" class="form-control"></td> -->
									...
									<input type="hidden" name="get_point_0[]" class="form-control">
								</tr>
							@endif
						</table>
					</div>
		...
		<div class="form-group">
			<div class="row">
				<div class="col-sm-2">
					<b>{{ isset($data['backendlang']['backendlang']['Iamge']) ? $data['backendlang']['backendlang']['Image'] :'' }}: </b>
				</div>
				<div class="col-sm-10">

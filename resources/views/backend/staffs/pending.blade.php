...
<div class="page-header">
    <h1>
        {{ isset($data['backendlang']['backendlang']['Agent_Pending_List']) ? $data['backendlang']['backendlang']['Agent_Pending_List'] :'' }}
        <!-- <small>
					...
					<td>
						@if(!empty($topup_bank_slip[$merchant->code]->bank_slip))
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="{{ asset($topup_bank_slip[$merchant->code]->bank_slip) }}" width="100px">						
							</a>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-body">
							        <img src="{{ asset($topup_bank_slip[$merchant->code]->bank_slip) }}" width="100%">
							      </div>
							    </div>
							  </div>
							</div>

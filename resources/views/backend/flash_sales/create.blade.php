...
@section('content')
	...
	@endif
	<form method="POST" action="{{ route('flash_sale.flash_sales.store') }}" id="flash-sale-form"
		...
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary save-password ms-1">
...
@section('js')
	...
	<script type="text/javascript">
		...
		$(document).on('click', '.remove_sub_item', function(e) {
			...
			if (confirm("{{ isset($data['backendlang']['backendlang']['Please_Select_Products']) ? $data['backendlang']['backendlang']['Please_Select_Products'] :'' }}")) {
				$.ajax({
					type: 'POST',
					contentType: false,
					processData: false,

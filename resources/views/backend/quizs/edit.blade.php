...
<form method="POST" action="{{ route('quiz.quizs.update', $quiz->id) }}" id="agent-form" enctype="multipart/form-data">
@csrf
@method('PUT')
            ...
            <div class="pb-4 w-100">
                <div class="row">
                    <div class="col-2" align="right">
                        <label>
                            ({{ isset($data['backendlang']['backendlang']['New']) ? $data['backendlang']['backendlang']['New'] :''}})</b>  {{ isset($data['backendlang']['backendlang']['Answer_Suggestion_EN']) ? $data['backendlang']['backendlang']['Answer_Suggestion_EN'] :''}}: <label class="important-text">*</label>
                        </label>
                    </div>
                    <div class="col-10">

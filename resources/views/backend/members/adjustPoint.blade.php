...
<div class="container-box form-group">
	...
	<div class="form-group">
		<span class="badge bg-primary">{{ isset($data['backendlang']['backendlang']['Topup_Point_Balance']) ? $data['backendlang']['backendlang']['Topup_Point_Balance'] :'' }}: {{ $GetCashWalletBalance }}</span>
	</div>
	<form method="POST" action="{{ route('adjustMemberPoint', $user->id) }}">
		@csrf
		@if($errors->any())
...
<div class="container-box">
	...
	<div class="row">
		<div class="col-sm-12">
			<form method="GET" action="{{ route('adjustMemberPoint', $user->id) }}">
				<div class="form-group">
					<div class="row">
						<div class="col-sm-2">
							<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<a href="{{ route('adjustMemberPoint', $user->id) }}" class="btn btn-warning btn-sm">

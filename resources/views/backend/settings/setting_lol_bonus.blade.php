		...
		<form method="POST" action="{{ route('setting_loo_bonus') }}" id="setting-merchant-form">
			...
			<div class="big-parent">
				<div class="form-group">
					<label> {{ isset($data['backendlang']['backendlang']['Minimum_Sales_Amount']) ? $data['backendlang']['backendlang']['Minimum_Sales_Amount'] :'' }} (RM)</label>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-3">
							<div class="form-group">
								<h5><b> {{ isset($data['backendlang']['backendlang']['Target']) ? $data['backendlang']['backendlang']['Target'] :'' }} (RM)</b></h5>
							</div>
						</div>
						<div class="col-3">
							<div class="form-group">
					...
					<div class="child-div">
						@foreach($SettingLolBonus as $SettingBonus)

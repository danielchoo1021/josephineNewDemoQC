...
<div class="row">
	<div class="col-12">
		<form method="POST" action="{{ route('setting_area_agent_level_save') }}" id="setting-merchant-form">
			@csrf
				...
				<div class="form-group">
					...
					<div class="child-div">
						...
						<div class="form-group child-row">
							<div class="row">
								<div class="col-6">
									<input type="text" name="area_agent_lvl[]" class="form-control" placeholder="e.g. Agent" value="{{ $level->area_agent_lvl }}">
									<input type="hidden" name="lvl_id[]" value="{{ $level->id }}">
								</div>
								<div class="col-6">
									<input type="text" name="area_agent_lvl_cn[]" class="form-control" placeholder="代理" value="{{ $level->area_agent_lvl_cn }}">
								</div>
							</div>
						</div>
						@endforeach
						<div class="form-group child-row">
							<div class="row">
								<div class="col-6">
									<input type="text" name="area_agent_lvl[]" class="form-control" placeholder="e.g. Agent">
									<input type="hidden" name="lvl_id[]">
								</div>
								<div class="col-6">
									<input type="text" name="area_agent_lvl_cn[]" class="form-control" placeholder="代理">
								</div>
							</div>
						</div>
					</div>					
...
<script type="text/javascript">
	...
	$('.submit-form-btn .btn-outline-primary').click( function(e){
    	...
    	$(".child-row input[name='area_agent_lvl[]']").each(function( index ) {

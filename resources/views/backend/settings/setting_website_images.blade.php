...
<div class="page-header">
    <h1>
       {{ isset($data['backendlang']['backendlang']['Setting_Banner']) ? $data['backendlang']['backendlang']['Setting_Banner'] :'' }}
    </h1>
</div>
...
<div class="form-group">
	<div class="row">
		<div class="col-sm-12">
			...
			<div>
				<form method="POST" action="{{ route('uploadWebsiteImage') }}" class="dropzone well" id="dropzone" enctype="multipart/form-data">
					@csrf
					<div class="fallback">
...
<script type="text/javascript">
	var url = '{{ route("LoadWebsiteImage") }}';
    ...
    $('.product-image-list').on('click', '.product-image-thumbnail .delete-image', function(e){
        ...
        if(confirm('{{ isset($data['backendlang']['backendlang']['Delete_This_Image']) ? $data['backendlang']['backendlang']['Delete_This_Image'] :'' }}') == true){
            var url = '{{ route("DeleteWebsiteImage", ":id") }}';

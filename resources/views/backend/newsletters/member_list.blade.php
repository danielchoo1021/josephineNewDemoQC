...
<div class="form-group">
	...
	<a href="{{ route('member_list') }}" class="btn btn-warning btn-sm">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					<td>
						{{ $key+1 }}
						<input type="hidden" class="row_id" name="row_id" value="{{ $user->id }}">
						<input type="checkbox" name="receive_newsletter" value="1" {{ $user->receive_newsletter == 1 ? 'checked' : '' }}>
						<input type="hidden" name="isAgent" value="{{ !empty($user->lvl) ? '1' : '0' }}">
					</td>

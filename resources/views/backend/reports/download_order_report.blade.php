<table>
	<tr>
		...
		<th></th>
		<th align="right">
			<b>{{ isset($data['backendlang']['backendlang']['Sales_Report']) ? $data['backendlang']['backendlang']['Sales_Report'] :'' }}</b>
		</th>
	</tr>
	<tr>
		<th>
...
<table class="table table-bordered">
	<thead>
		<tr class="info">
			...
			<th style="text-align: right;">{{ isset($data['backendlang']['backendlang']['Sales']) ? $data['backendlang']['backendlang']['Sales'] :'' }} (RM)</th>
			<th style="text-align: right;">{{ isset($data['backendlang']['backendlang']['Net_Sales']) ? $data['backendlang']['backendlang']['Net_Sales'] :'' }} (RM)</th>
			<th style="text-align: right;">{{ isset($data['backendlang']['backendlang']['Total_Net_Sales_(RM)']) ? $data['backendlang']['backendlang']['Total_Net_Sales_(RM)'] :'' }} (RM)</th>

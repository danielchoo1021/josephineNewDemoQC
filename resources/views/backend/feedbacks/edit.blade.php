...
@endif
<form method="POST" action="{{ route('feedback.feedbacks.update', $feedback->id) }}" id="agent-form" enctype="multipart/form-data">
@csrf
@method('PUT')
...
<script type="text/javascript">
    ...
    var url = '{{ route("LoadFeedbackImage", ":id") }}';
        url = url.replace(':id', '{{ $feedback->id }}');

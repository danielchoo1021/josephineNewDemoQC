...
{
    protected $fillable = [
        'featured', 'featured_display_name', 'featured_point_1', 'featured_point_2', 'featured_point_3', 'featured_image',
        'packages', 'item_code', 'product_code',  'product_name', 'category_id', 'sub_category_id', 'brand_id',

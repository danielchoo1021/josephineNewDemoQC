...
class PointOrderExport extends \PhpOffice\PhpSpreadsheet\Cell\StringValueBinder implements WithCustomValueBinder, FromView
{
    /**
    ...
    */
    ...
    {   
        ...
        return view('backend.reports.download_point_order_report', compact('transactions', 'details', 'details2', 'start', 'end'));
    }
}
